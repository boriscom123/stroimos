...
use Application\Sonata\MediaBundle\DependencyInjection\SonataMediaModificationCompilerPass;
...
class ApplicationSonataMediaBundle extends Bundle
{
    ...
    {
        $container->addCompilerPass(new SonataMediaModificationCompilerPass(), PassConfig::TYPE_BEFORE_REMOVING);
    }
}