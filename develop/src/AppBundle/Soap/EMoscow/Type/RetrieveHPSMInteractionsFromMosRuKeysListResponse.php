...
class RetrieveHPSMInteractionsFromMosRuKeysListResponse
{
     ...
     * @param int $start
     */
    public function __construct($keys, $messages, $status, $message, $schemaRevisionDate, $schemaRevisionLevel, $returnCode, $query, $handle, $count, $more, $start)
    {
      $this->keys = $keys;
    ...
    /**
     * @param HPSMInteractionsFromMosRuKeysType $keys
     * @return \AppBundle\Soap\EMoscow\Type\RetrieveHPSMInteractionsFromMosRuKeysListResponse
     */
