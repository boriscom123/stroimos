...
class RetrieveHPSMInteractionsFromMosRuResponse
{
     ...
     * @param int $start
     */
    public function __construct($model, $messages, $status, $message, $schemaRevisionDate, $schemaRevisionLevel, $returnCode, $query, $handle, $count, $more, $start)
    {
      $this->model = $model;
    ...
    /**
     * @param HPSMInteractionsFromMosRuModelType $model
     * @return \AppBundle\Soap\EMoscow\Type\RetrieveHPSMInteractionsFromMosRuResponse
     */
