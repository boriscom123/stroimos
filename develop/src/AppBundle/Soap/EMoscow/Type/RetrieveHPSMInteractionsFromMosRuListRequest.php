...
class RetrieveHPSMInteractionsFromMosRuListRequest
{
     ...
     */
    public function __construct($keys, $attachmentInfo, $attachmentData, $ignoreEmptyElements, $updatecounter, $handle, $count, $start, $attachmentType)
    {
      $this->keys = $keys;
    ...
    /**
     * @param HPSMInteractionsFromMosRuKeysType $keys
     * @return \AppBundle\Soap\EMoscow\Type\RetrieveHPSMInteractionsFromMosRuListRequest
     */
