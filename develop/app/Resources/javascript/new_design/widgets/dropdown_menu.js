...
//
    ...
    var $mainHeaderDropBtn = $('.main-header__drop-btn');
    var $mainHeaderMenuDrop = $('.main-header__menu-drop');

    $mainHeaderDropBtn.on('click', function(e) {
        var $this = $(this);
        e.preventDefault();

        if (!$this.hasClass('active')) {
            $this.addClass('active');
            $mainHeaderMenuDrop.addClass('active');
        } else {
            $this.removeClass('active');
            $mainHeaderMenuDrop.removeClass('active');
        }
    })
