 ...
 */
class PostAttachment extends \AppBundle\Entity\PostAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\PostAttachment' . "\0" . 'id', 'post', 'title', 'file', 'position');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PostAttachment $proxy) {
