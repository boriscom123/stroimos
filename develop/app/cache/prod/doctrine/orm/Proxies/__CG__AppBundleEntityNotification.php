...
class Notification extends \AppBundle\Entity\Notification implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Notification' . "\0" . 'id', 'createdAt', 'username', 'module', 'entityId', 'countable');
        }
    ...
    public function isCountable()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isCountable', array());
    ...
    public function setCountable($countable)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCountable', array($countable));

        return parent::setCountable($countable);
    }
