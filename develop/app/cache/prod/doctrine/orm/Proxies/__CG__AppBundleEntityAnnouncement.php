 ...
 */
class Announcement extends \AppBundle\Entity\Announcement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Announcement' . "\0" . 'id', 'date', 'post', 'title', 'content', 'image', '' . "\0" . 'AppBundle\\Entity\\Announcement' . "\0" . 'entityLock', 'publishable', 'publishStartDate', 'publishEndDate', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'deletedBy');
        }
