 ...
 */
class Block extends \AppBundle\Entity\Block implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'container', 'settings', 'enabled', 'position', 'type', 'ttl', 'page', 'createdAt', 'updatedAt', 'name', 'parent', 'children');
        }
