 ...
 */
class OrganizationDirectory extends \AppBundle\Entity\OrganizationDirectory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\OrganizationDirectory' . "\0" . 'id', 'title', 'publishable', 'createdAt', 'updatedAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OrganizationDirectory $proxy) {
