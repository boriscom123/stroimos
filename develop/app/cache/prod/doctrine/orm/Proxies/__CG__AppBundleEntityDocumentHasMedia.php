 ...
 */
class DocumentHasMedia extends \AppBundle\Entity\DocumentHasMedia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\DocumentHasMedia' . "\0" . 'id', 'document', 'title', 'file', 'position');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DocumentHasMedia $proxy) {
