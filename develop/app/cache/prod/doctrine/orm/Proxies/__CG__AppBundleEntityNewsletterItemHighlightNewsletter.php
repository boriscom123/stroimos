 ...
 */
class HighlightNewsletter extends \AppBundle\Entity\NewsletterItem\HighlightNewsletter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'title', 'id', 'teaser', 'content', 'image', 'link', 'isTargetBlank');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HighlightNewsletter $proxy) {
