 ...
 */
class MetroStationImage extends \AppBundle\Entity\MetroStationImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'title', '' . "\0" . 'AppBundle\\Entity\\MetroStationImage' . "\0" . 'id', 'metroStation', 'position', 'teaser', 'metaDescription', 'metaKeywords', 'image', '' . "\0" . 'AppBundle\\Entity\\MetroStationImage' . "\0" . 'tags', 'publishable', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'deletedBy');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MetroStationImage $proxy) {
    ...
    public function getMetroStation()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMetroStation', array());

        return parent::getMetroStation();
    }

    /**
     * {@inheritDoc}
     */
    public function setMetroStation(\AppBundle\Entity\MetroStation $metroStation = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMetroStation', array($metroStation));

        return parent::setMetroStation($metroStation);
    }
