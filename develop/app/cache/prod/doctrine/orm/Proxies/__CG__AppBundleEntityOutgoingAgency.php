 ...
 */
class OutgoingAgency extends \AppBundle\Entity\OutgoingAgency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\OutgoingAgency' . "\0" . 'id', 'lawDocuments', 'title', 'createdBy', 'updatedBy', 'deletedBy');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OutgoingAgency $proxy) {
    ...
    public function getLawDocuments()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLawDocuments', array());

        return parent::getLawDocuments();
    }
    ...
    public function setLawDocuments($lawDocuments)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLawDocuments', array($lawDocuments));

        return parent::setLawDocuments($lawDocuments);
    }

    /**
     * {@inheritDoc}
     */
    public function addLawDocument(\AppBundle\Entity\LawDocument $document)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addLawDocument', array($document));

        return parent::addLawDocument($document);
    }
