 ...
 */
class ActionLog extends \AppBundle\Entity\ActionLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ActionLog' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\ActionLog' . "\0" . 'date', '' . "\0" . 'AppBundle\\Entity\\ActionLog' . "\0" . 'action', '' . "\0" . 'AppBundle\\Entity\\ActionLog' . "\0" . 'username', '' . "\0" . 'AppBundle\\Entity\\ActionLog' . "\0" . 'message', '' . "\0" . 'AppBundle\\Entity\\ActionLog' . "\0" . 'user', '' . "\0" . 'AppBundle\\Entity\\ActionLog' . "\0" . 'ip', 'module', 'title', 'url');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ActionLog $proxy) {
