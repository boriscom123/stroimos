 ...
 */
class ExtraInformation extends \AppBundle\Entity\ExtraInformation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'content', 'createdAt', 'updatedAt', 'createdBy', 'updatedBy', 'deletedBy', '' . "\0" . 'AppBundle\\Entity\\ExtraInformation' . "\0" . 'entityLock');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExtraInformation $proxy) {
