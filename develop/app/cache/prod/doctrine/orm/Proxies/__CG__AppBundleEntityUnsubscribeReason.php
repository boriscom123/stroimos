 ...
 */
class UnsubscribeReason extends \AppBundle\Entity\UnsubscribeReason implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\UnsubscribeReason' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\UnsubscribeReason' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\UnsubscribeReason' . "\0" . 'reason', '' . "\0" . 'AppBundle\\Entity\\UnsubscribeReason' . "\0" . 'comment', 'createdAt', 'updatedAt');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UnsubscribeReason $proxy) {
