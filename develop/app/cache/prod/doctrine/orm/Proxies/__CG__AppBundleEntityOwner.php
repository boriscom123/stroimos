 ...
 */
class Owner extends \AppBundle\Entity\Owner implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'id', 'organization');
        }
    ...
    public function getFormName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFormName', array());
