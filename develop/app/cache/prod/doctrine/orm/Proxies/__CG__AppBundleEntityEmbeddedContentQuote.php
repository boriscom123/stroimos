 ...
 */
class Quote extends \AppBundle\Entity\EmbeddedContent\Quote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'pages', 'text', 'person', 'id', 'title', 'publishable', 'createdBy', 'updatedBy', 'deletedBy', 'createdAt', 'updatedAt');
        }
