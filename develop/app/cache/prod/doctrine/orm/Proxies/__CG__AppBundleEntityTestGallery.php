 ...
 */
class TestGallery extends \AppBundle\Entity\TestGallery implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\TestGallery' . "\0" . 'id', 'gallery', 'image');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TestGallery $proxy) {
