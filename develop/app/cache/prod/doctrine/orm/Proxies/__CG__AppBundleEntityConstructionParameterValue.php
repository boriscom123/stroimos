 ...
 */
class ConstructionParameterValue extends \AppBundle\Entity\ConstructionParameterValue implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'value', 'weight', 'construction', 'constructionParameter', 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ConstructionParameterValue $proxy) {
