 ...
 */
class PostPicksHistory extends \AppBundle\Entity\PostPicksHistory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\PostPicksHistory' . "\0" . 'id', 'date', 'posts');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PostPicksHistory $proxy) {
