 ...
 */
class QuestionAnswer extends \AppBundle\Entity\EmbeddedContent\Faq\QuestionAnswer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'question', 'weight', 'answer', 'faqBlock', 'id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (QuestionAnswer $proxy) {
    ...
    public function getFaqBlock()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFaqBlock', array());

        return parent::getFaqBlock();
    }
    ...
    public function setFaqBlock($faqBlock)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFaqBlock', array($faqBlock));

        return parent::setFaqBlock($faqBlock);
    }
