...
class Category extends \AppBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'id', 'article', 'posts', 'alias', 'title');
        }
    ...
    public function isArticle()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isArticle', array());

        return parent::isArticle();
    }
